    ...
    public partial class WebWordPressLibraryRepositoryFolders
    {
        ...
        public partial class WordPress_DemoAppFolder : RepoGenBaseFolder
        {
                    ...
                    base("WordPress_Demo", "/dom[@domain='webtest.ranorex.org']", parentFolder, 30000, null, false, "1155ad1c-67f9-47e2-b216-3b27bda1db0b", "")
            {
                ...
                _publishInfo = new RepoItemInfo(this, "Publish", ".//input[#'publish']", 30000, null, "87655afb-b7fd-4c8f-a620-fb5852b80b45");
                _tinymceInfo = new RepoItemInfo(this, "Tinymce", ".//iframe[@id='content_ifr']//body[#'tinymce']", 30000, null, "291de324-0ec8-41fd-b8f4-9ddb1504c48e");
                _myaccount1Info = new RepoItemInfo(this, "MyAccount1", ".//li[#'wp-admin-bar-my-account']/a[@innertext='Howdy, Ranorex Webtest']", 30000, null, "941d4a5d-4fc3-4bce-b0b7-f75c361aec56");
            ...
            /// The Tinymce item.
            /// </summary>
            [RepositoryItem("291de324-0ec8-41fd-b8f4-9ddb1504c48e")]
            public virtual Ranorex.BodyTag Tinymce
            {
                get
                {
                    return _tinymceInfo.CreateAdapter<Ranorex.BodyTag>(true);
                }
            }

            /// <summary>
            /// The Tinymce item info.
            /// </summary>
            [RepositoryItemInfo("291de324-0ec8-41fd-b8f4-9ddb1504c48e")]
            public virtual RepoItemInfo TinymceInfo
            {
                get
                {
                    return _tinymceInfo;
