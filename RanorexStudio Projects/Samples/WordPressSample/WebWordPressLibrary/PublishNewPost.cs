...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$varPostTitle' with focus on 'WordPress_Demo.Title'.", repo.WordPress_Demo.TitleInfo, new RecordItemIndex(1));
            repo.WordPress_Demo.Title.PressKeys(varPostTitle);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'WordPress_Demo.Tinymce' at 199;67.", repo.WordPress_Demo.TinymceInfo, new RecordItemIndex(2));
            repo.WordPress_Demo.Tinymce.Click("199;67");
            Delay.Milliseconds(200);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$varPostContent' with focus on 'WordPress_Demo.Tinymce'.", repo.WordPress_Demo.TinymceInfo, new RecordItemIndex(3));
            repo.WordPress_Demo.Tinymce.PressKeys(varPostContent);
            Delay.Milliseconds(0);
