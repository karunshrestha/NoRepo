...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Website", "Opening web site URL in variable $varLoginURL with browser 'IE' in maximized mode.", new RecordItemIndex(0));
            Host.Local.OpenBrowser(varLoginURL, "IE", "", false, true, false, false, false);
