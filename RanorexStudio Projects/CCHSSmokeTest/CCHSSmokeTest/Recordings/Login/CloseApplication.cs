...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("73cd2d0d-d3af-4ec5-92ed-97fe3ff11b00", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'NewOceanAdminPortal'.", repo.NewOceanAdminPortal.SelfInfo, new RecordItemIndex(0));
            Host.Local.CloseApplication(repo.NewOceanAdminPortal.Self, new Duration(0));
